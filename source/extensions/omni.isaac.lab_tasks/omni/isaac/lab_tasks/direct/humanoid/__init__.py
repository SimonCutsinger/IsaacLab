...
from .humanoid_treasure_env import HumanoidTreasureEnv, HumanoidTreasureCfg
...
gym.register(
    id="Isaac-H1-Treasure-v0",
    entry_point="omni.isaac.lab_tasks.direct.humanoid:HumanoidTreasureEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": HumanoidTreasureCfg,
        "rl_games_cfg_entry_point": f"{agents.__name__}:rl_games_ppo_cfg.yaml",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:HumanoidPPORunnerCfg",
        "skrl_cfg_entry_point": f"{agents.__name__}:skrl_ppo_cfg.yaml",
    },
